...
import { Plus, Video, Keyboard, ArrowRight, User } from 'lucide-react'
...
const App = () => {
  ...
  const handleJoin = () => {
    ...
    console.log('Joining session:', joinId, 'as', name);
  };
                    ...
                    >
                      {!createdId ? (
                        ...
                        >
                          ...
                          <div className="bg-white/[0.05] border border-white/10 p-6 rounded-2xl mb-8 group cursor-pointer hover:border-white/30 transition-all">
