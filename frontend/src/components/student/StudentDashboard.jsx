    ...
    return (
        <div className="flex flex-col h-screen bg-background-primary">
            ...
            >
                ...
                >
                    {isControlledByTeacher && (
                        <div className="bg-status-warning/20 text-status-warning text-xs px-3 py-1 border-b border-status-warning/30">
                    ...
                    <div className="h-40 shrink-0 border-t border-white/[0.04]">
                        <OutputPanel
                            output={output}
                            error={error}
                            isRunning={isRunning}
